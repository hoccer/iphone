...
- (void)layoutSubviews  {
	...
	self.titleLabel.textColor = [UIColor colorWithRed:0.78 green:0.78 blue:0.78 alpha:0.8];
	self.titleLabel.frame = CGRectMake(self.titleLabel.frame.origin.x + textLabelOffset, self.frame.size.height - 13, 
